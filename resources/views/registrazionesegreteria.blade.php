    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="jumbotron pb-3 pt-3" style="background-color: #b9f8b9">
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <form method="post" action="{{route("segreteria")}}">
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" style="background-color: #00d154"><i
                                        ...
                                        <div class="form-group mt-3">
                                            <input class="btn btn-block btn-dark" type="submit" name="submit"
                                                   value="Iscrivi" onclick="validatePassword()">
                                        </div>
                                        @csrf
