            ...
            <div class="row">
                ...
                <div class="col-8 mt-5">
                    <div class="alert alert-info">
                        <strong>Nota Bene:</strong> Una volta iscritto, il socio dovrà essere verbalizzato dall'admin nella sezione Dashboard.
                    </div>
                    <div class="jumbotron mt-4" style="margin-top: -15px;background-color: #cdf5de">
                        <div class="row">
                            <div class="col-6">

                                <input type="text" class="jumbotron mr-1 text-center" id="jumbo1" value="ALLIEVO" name="allievo"
                                     style="width: 100%;background-color: #ffffff;border:#13ce66 solid 5px;border-radius: 6px;cursor: pointer" readonly
                                     onclick="turnGreenAll();toogleScelta(1);">
                            </div>
                            <div class="col-6">
                                <input type="text" class="jumbotron ml-1 text-center" id="jumbo2" value="INSEGNANTE" name="insegnante"
                                     style="width: 100%;background-color: #ffffff;border:#13ce66 solid 5px;border-radius: 6px;cursor: pointer" readonly
