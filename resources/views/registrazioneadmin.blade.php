                                ...
                                <div class="col-12 col-lg-6">
                                    <form method="post" action="{{route("admin")}}">
                                        ...
                                        <div class="form-group mt-3">
                                            <input class="btn btn-block btn-dark" type="submit" name="submit" value="Iscrivi e Termina">
                                        </div>
                                        <div class="form-group mt-3">
                                            <input class="btn btn-block btn-dark" type="submit" name="submit" value="Iscrivi e Registra Segreteria">
                                        </div>
                                        @csrf
