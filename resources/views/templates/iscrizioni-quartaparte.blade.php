...
<div class="row mt-4">
    ...
    <div class="col-11 col-lg-9"></div>
        <div id="divSconto" class="col-12 col-lg-2 px-2" style="margin-top: -2.75rem;">
            ...
            <h4 class="pl-2" style="border: 2px dashed black; border-radius: 5px;"> Sconto del XX%<?php //TODO inserire sconto pacchetti ?>!</h4>
        </div>
    ...
    <div class="col-12 col-lg-12 mt-5 ml-n4">
        <div class="form-group">
            ...
            <input type="submit" class="btn btn-dark mt-3 float-right"
                   style="font-size: 22px; cursor: pointer;" name="continuaCorso"
                   id="continuaCorso" value="Continua">
        </div>
    </div>
    @csrf
    </form>
    ...
    <form action="" method="post">
        <div class="form-group">
            ...
            <input type="submit" class="btn btn-dark mt-5 float-right"
                   ...
                   name="continua"
                   id="continua" value="Continua Senza Iscrizione al Corso" formnovalidate>
        </div>
    </form>
</div>
<div class="col-0 col-lg-2"></div>
